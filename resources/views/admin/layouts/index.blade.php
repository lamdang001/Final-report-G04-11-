...
<head>
    ...
    <title>{{ Auth::guard('admin')->user()->name }}</title>
    <base href="{{ asset('') }}" >
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <script type="text/javascript" src="assets/admin/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script type="text/javascript" src="assets/admin/dist/js/sb-admin-2.js"></script>
    ...
    <!-- Handle -->
    <script type="text/javascript" src="assets/admin/dist/js/script.js"></script>
